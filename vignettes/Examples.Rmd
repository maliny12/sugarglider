...
p1 <- aus_temp |>
  ...
  geom_sf(data = abs_ste, color = grey(0.7), fill = NA,
          inherit.aes = FALSE)  +
  add_glyph_boxes(color = "dodgerblue3") +
  add_ref_lines(color = "dodgerblue3") +
  geom_glyph_ribbon(global_rescale = FALSE, color = "dodgerblue3", fill = "dodgerblue3") +
  theme_map() +
...
p2 <- aus_temp |>
  ...
  geom_sf(data = abs_ste, color = grey(0.7), fill = NA,
   ...
   add_glyph_boxes(color = "dodgerblue3") +
   add_ref_lines(color = "dodgerblue3") +
  geom_glyph_ribbon(global_rescale = TRUE, color = "dodgerblue3", fill = "dodgerblue3") +
  theme_map() +
  coord_sf(xlim = c(110,155)) +
